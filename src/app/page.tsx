    ...
    <main className="min-h-screen bg-[#fafaf8] text-gray-900">
      ...
      >
        ...
        <div className="relative mx-auto max-w-6xl px-6 pt-14 pb-10">
          ...
          {/* Tops aligned, no forced equal heights */}
          <div className="mt-12 grid gap-10 md:grid-cols-2 md:items-start">
            <div>
              ...
              <div className="mt-8 rounded-3xl border border-gray-200 bg-white/85 p-5 backdrop-blur shadow-sm">
                ...
                <SearchCapture
                  onSuccess={() => setToast("Got it. I’ll follow up with matches shortly.")}
                />
              </div>
          ...
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            <div>
              ...
              <div className="space-y-4">
                ...
                />
                <FeatureLine title="Sharp offer strategy" body="Data-driven pricing plus negotiation that wins." />
            ...
            <div className="rounded-3xl bg-gradient-to-br from-gray-50 to-gray-100 p-8 border border-gray-200">
              ...
              <div className="space-y-6">
                ...
                <StepLine n="2" title="Personalized search" body="Curated listings plus showings that match your criteria." />
            ...
            <div className="order-2 md:order-1 rounded-3xl bg-white p-8 border border-gray-200 shadow-sm">
              ...
              <div className="space-y-6">
                <StepLine
                  ...
                  body="Comp analysis plus insights to price competitively without leaving money behind."
                />
                <StepLine
                  n="✓"
                  title="Strategic staging and prep"
              ...
              <ul className="mt-8 grid gap-3 md:grid-cols-2 text-sm text-gray-700">
                ...
                <li className="flex gap-2">
                  <span className="font-semibold">•</span> Offer review focused on net plus certainty
                </li>
                <li className="flex gap-2">
